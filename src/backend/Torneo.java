...
import backendExceptions.LasMaquinasNoSeRindenException;
...
public class Torneo {
	...
	private void nuevoAhorcado() {
		if (juegaElHumano()) {
			...
			this.ahorcado = new JuegoAhorcado(this.idiomaActual, this.dificultadActual,
					this.desafioPropuestoPorJugador);
	...
	public void perderTurno() throws LasMaquinasNoSeRindenException {
		if (juegaElHumano()) {
			...
			throw new LasMaquinasNoSeRindenException(
					"No se puede perder el turno \n" + "La IA nunca se da por vencida.");
		}
	}
